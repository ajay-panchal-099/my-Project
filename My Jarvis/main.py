...
booting = ['Scarlet Assistant version 1.0 has begun', 'Scarlet Assistant at your service',
           'Currently starting Scarlet Virtual Assistant']
greetings = ["hello", "hello there", "Hi,I am Scarlet", "What is up user", "Greetings human", "Your wish is my command",
...
def locate(data):
    ...
    engine.runAndWait()
    webbrowser.get("C:/Program Files (x86)/Google/Chrome/Application/chrome.exe %s").open(
        "https://www.google.ca/maps/place/" + place + "/")
    main()
